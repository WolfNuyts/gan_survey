...
if __name__ == '__main__':
    ...
    greeting = Label(popup,
                     text="Hallo, "
                          ...
                          "de tekst beschreven staat. De bedoeling is om deze keer de kwaliteit niet in "
                          ...
                          "dan is het belangrijk dat je de afbeeldingen dus beoordeelt over dat ze exact 2 vrouwen "
