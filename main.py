...
if __name__ == '__main__':
    ...
    greeting = Label(popup,
                     text="Hallo, "
                          ...
                          "\n\nDe tweede keer tonen we ook een tekst beschrijving van de afbeelding en "
                          "vragen we u om de afbeelding te ranken op hoe goed deze afbeeldingen afbeelden wat er in "
                          "de tekst beschreven straat. De bedoeling is om deze keer de kwaliteit helemaal NIET in "
                          "rekening te brengen maar dus enkel te focussen dat alle delen van de tekst beschrijving "
                          "afgebeeld zijn."
